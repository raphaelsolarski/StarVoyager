...
ScoresMenu::ScoresMenu()
{
	...
	restumeButton.setTextureRect(sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(63, 27)));
	restumeButton.setPosition(sf::Vector2f(269, 200));
	interactiveElements.push_back(restumeButton);

	/* puki co wy�wietlam tylko top 10, a potem zaimplementuj� przewijanie
	//przycisk "NEXT PAGE"
